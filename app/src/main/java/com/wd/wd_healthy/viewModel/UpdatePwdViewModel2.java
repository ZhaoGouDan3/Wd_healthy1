 ...
 * @date 2022/9/14
 */
public class UpdatePwdViewModel2 extends ViewModel {
    public MediatorLiveData<SendEmailBean> liveData=new MediatorLiveData<>();
    public MediatorLiveData<SendEmailBean> getLiveData(String pwd1,String pwd2){
        HttpUtils.getInstance()
                .getApiService()
                .updatePwd(SpUtils.getString("userId"),SpUtils.getString("sessionId"), pwd1,pwd2)
