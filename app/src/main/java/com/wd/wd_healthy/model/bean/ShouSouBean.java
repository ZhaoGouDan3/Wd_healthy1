...
public class ShouSouBean {

    /**
     * result : {"diseaseSearchVoList":[{"diseaseId":123,"diseaseName":"新生儿黄疸"}],"doctorSearchVoList":[{"doctorId":1,"doctorName":"李医生"},{"doctorId":2,"doctorName":"罗医生"}],"drugsSearchVoList":[{"drugsId":59,"drugsName":" [小施尔康]小儿多维生素咀嚼片(10) "},{"drugsId":84,"drugsName":" [首儿]小儿生血糖浆 "},{"drugsId":86,"drugsName":" [小施尔康]小儿多维生素咀嚼片(10) "},{"drugsId":87,"drugsName":" [养生堂]毛绒玩具(赠品 随机) "},{"drugsId":92,"drugsName":" [伊可新]维生素AD滴剂(胶囊型 1岁以上) "}]}
     * message : 搜索成功
     * status : 0000
     */
